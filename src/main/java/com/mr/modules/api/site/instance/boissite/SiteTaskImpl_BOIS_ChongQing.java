...
import com.mr.modules.api.util.ParseChongQing;
...
@Component("chongqing")
@Scope("prototype")
public class SiteTaskImpl_BOIS_ChongQing {
   /* @Override
    protected String execute() throws Throwable {
        String url = "http://chongqing.circ.gov.cn/web/site40/tab3460/info100216.htm";
        Map<String,String> mapInfo = extractContent(getData(url));
        return null;
    }*/
