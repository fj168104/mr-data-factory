...
@Component("fujian")
@Scope("prototype")
public class SiteTaskImpl_BOIS_FuJian extends SiteTaskExtend{
    @Override
    protected String execute() throws Throwable {
//        String url = "http://fujian.circ.gov.cn/web/site13/tab3386/module9903/page1.htm";
    ...
    public List extractPageUrlList(){
        ...
        //第一个页面，用于获取总页数
        String baseUrl = "http://fujian.circ.gov.cn/web/site13/tab3386/module9903/page1.htm";
        //解析第一个页面，获取这个页面上下文
        ...
        for(int i=1;i<=pageAll;i++){
            ...
            for(Element element : elementsHerf){
                ...
                String resultUrl = "http://fujian.circ.gov.cn"+elementUrl.attr("href");
    ...
    public Map extractContent(String fullTxt) {
        //发布机构
        String publishOrg = "中国保监会福建监管局行政处";
        //发布时间
        String publishDate = "";
        //TODO 处罚机关（由于有些页面没有，所以暂且给予默认值）
        String punishOrg = "中国保险监督管理委员会福建监管局";
        //TODO 处罚时间
        String punishDate = "";
        //TODO 处罚文号
        String punishNo = "";
