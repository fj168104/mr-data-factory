...
import com.mr.modules.api.util.ParseGanSu;
...
@Component("gansu")
@Scope("prototype")
public class SiteTaskImpl_BOIS_GanSu{
    /*@Override
    protected String execute() throws Throwable {
        String url = "http://gansu.circ.gov.cn/web/site14/tab3389/info141103.htm";
    ...
    public Map extractContent(String fullTxt) {
        //发布机构
        String publishOrg = "中国保监会甘肃监管局行政处";
        //发布时间
        String publishDate = "";
