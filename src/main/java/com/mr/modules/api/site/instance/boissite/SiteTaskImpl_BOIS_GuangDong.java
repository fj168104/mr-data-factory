...
@Component("guangdong")
@Scope("prototype")
public class SiteTaskImpl_BOIS_GuangDong extends SiteTaskExtendSub{
    @Override
    protected String execute() throws Throwable {
//        String url = "http://guangdong.circ.gov.cn/web/site15/tab3454/module9049/page2.htm";
    ...
    public List extractPageUrlList(){
        ...
        //第一个页面，用于获取总页数
        String baseUrl = "http://guangdong.circ.gov.cn/web/site15/tab3454/module9049/page1.htm";
        //解析第一个页面，获取这个页面上下文
        String fullTxt = getData(baseUrl);
        //获取页数
        int  pageAll= extractPage(fullTxt);
        for(int i=1;i<=pageAll;i++){
            String url ="http://guangdong.circ.gov.cn/web/site15/tab3454/module9049/page"+i+".htm";
    ...
    public Map extractContent(String fullTxt) {
        //发布机构
        String publishOrg = "中国保监会广东保监局";
        //发布时间
        String publishDate = "";
        //TODO 处罚机关（由于有些页面没有，所以暂且给予默认值）
        String punishOrg = "广东保监局";
        //TODO 处罚时间
        String punishDate = "";
        //TODO 处罚文号
        String punishNo = "";
        ...
        String txtAll= elementsTxt.text().replace(":","：")
                ...
                .replace("总  经  理：","负责人人：")
                .replace("营业地址：","地址：")
                .replace("原工作单位地址/住址：","地址：")
                .replace("工作单位地址：","地址：")
                .replace("工作单位地址/住址：","地址：")
                .replace("工作单位地址 ","地址：")
                .replace("地 址：","地址：")
                .replace("住  址：","地址：")
                .replace("住 址：","地址：")
