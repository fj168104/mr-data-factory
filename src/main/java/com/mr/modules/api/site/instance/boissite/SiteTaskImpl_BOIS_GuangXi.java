...
@Component("guangxi")
@Scope("prototype")
public class SiteTaskImpl_BOIS_GuangXi extends SiteTaskExtendSub{
     @Override
    protected String execute() throws Throwable {
//        String url = "http://guangxi.circ.gov.cn/web/site16/tab3448/module9055/page1.htm";
    ...
    public List extractPageUrlList(){
        ...
        //第一个页面，用于获取总页数
        String baseUrl = "http://guangxi.circ.gov.cn/web/site16/tab3448/module9055/page1.htm";
        //解析第一个页面，获取这个页面上下文
        String fullTxt = getData(baseUrl);
        //获取页数
        int  pageAll= extractPage(fullTxt);
        for(int i=1;i<=pageAll;i++){
            String url ="http://guangxi.circ.gov.cn/web/site16/tab3448/module9055/page"+i+".htm";
            ...
            for(Element element : elementsHerf){
                ...
                String resultUrl = "http://guangxi.circ.gov.cn"+elementUrl.attr("href");
    ...
    public Map extractContent(String fullTxt) {
        //发布机构
        String publishOrg = "中国保监会广西保监局行政处";
        //发布时间
        String publishDate = "";
        //TODO 处罚机关（由于有些页面没有，所以暂且给予默认值）
        String punishOrg = "广西保监局";
        //TODO 处罚时间
        String punishDate = "";
        //TODO 处罚文号
        String punishNo = "";
        ...
        String txtAll= elementsTxt.text().replace(":","：")
                ...
                .replace("主要负责人姓名：","负责人：")
                .replace("主要负责 人：","负责人：")
                .replace("副总经理（主持工作）：","当事人：")
                .replace("姓名：","当事人：")
                .replace("受处罚人：","当事人：")
                .replace("受处理人：","当事人：")
                .replace("主要负责人当事人：","当事人：")
                .replace("总  经  理：","负责人人：")
                .replace("营业地址：","地址：")
                .replace("住      所：","地址：")
                .replace("住      所：","地址：")
        ...
        if(txtAll.contains("当事人：")){
            for(String arrStr : txtAllArr){
                ...
                if(arrStr.contains("年")&&arrStr.trim().endsWith("日")){
                    //TODO 处罚时间
        ...
        if((punishNo.equals("")||punishNo.equals("null")||punishNo.equals("NULL")||punishNo==null)&&titleStr.contains("保监罚")&&titleStr.contains("号")&&titleStr.contains("（")){
