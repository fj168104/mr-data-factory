...
@Component("chongqing")
@Scope("prototype")
public class SiteTaskImpl_BOIS_HaiNan extends SiteTaskExtend{
    /**
     * 海南保监局处罚 提取所需要的信息
...
protected String execute() throws Throwable {
    String url = "http://www.circ.gov.cn/web/site18/tab3416/info4084578.htm";
    String fullTxt = getData(url);
    extractContent(fullTxt);
    log.info("----------------------海南保监局处罚信息提取完成------------------------");
    return null;
}
}	
