...
import com.mr.modules.api.site.instance.boissite.util.ParseHeNan;
...
//        String url = "http://henan.circ.gov.cn/web/site10/tab3426/module9897/page1.htm";
    ...
    public Map extractContent(String fullTxt) {
        ...
        Map resMap = new ParseHeNan().parseInfo(fullTxt);
