...
@Component("hubei")
@Scope("prototype")
public class SiteTaskImpl_BOIS_HuBei extends SiteTaskExtend{
    /**
     * 湖北保监局处罚 提取所需要的信息
...
protected String execute() throws Throwable {
    String url = "http://www.circ.gov.cn/web/site21/tab3434/info4102039.htm";
    String fullTxt = getData(url);
    extractContent(fullTxt);
    log.info("----------------------湖北保监局处罚信息提取完成------------------------");
    return null;
}
}	
