...
@Component("hunan")
@Scope("prototype")
public class SiteTaskImpl_BOIS_HuNan extends SiteTaskExtend{
    /**
     * 湖南保监局处罚 提取所需要的信息
...
protected String execute() throws Throwable {
    String url = "http://www.circ.gov.cn/web/site22/tab3410/info4103573.htm";
    String fullTxt = getData(url);
    extractContent(fullTxt);
    log.info("----------------------湖南保监局处罚信息提取完成------------------------");
    return null;
}
}	