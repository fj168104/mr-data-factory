...
import com.mr.modules.api.site.instance.boissite.util.ParseJiangSu;
...
@Component("jiangsu")
@Scope("prototype")
public class SiteTaskImpl_BOIS_JiangSu extends SiteTaskExtendSub{
    @Override
    protected String execute() throws Throwable {
//        String url = "http://jiangsu.circ.gov.cn/web/site24/tab3392/info4014689.htm";
    ...
    */public List extractPageUrlList(){
        ...
        //第一个页面，用于获取总页数
        String baseUrl = "http://jiangsu.circ.gov.cn/web/site24/tab3392/module8911/page1.htm";
        //解析第一个页面，获取这个页面上下文
        String fullTxt = getData(baseUrl);
        //获取页数
        int  pageAll= extractPage(fullTxt);
        for(int i=1;i<=pageAll;i++){
            String url ="http://jiangsu.circ.gov.cn/web/site24/tab3392/module8911/page"+i+".htm";
            ...
            for(Element element : elementsHerf){
                ...
                String resultUrl = "http://jiangsu.circ.gov.cn"+elementUrl.attr("href");
    ...
    public Map extractContent(String fullTxt) {
        //发布机构
        String publishOrg = "中国保监会江苏保监局行政处";
        //发布时间
        String publishDate = "";
        //TODO 处罚机关（由于有些页面没有，所以暂且给予默认值）
        String punishOrg = "江苏保监局";
        //TODO 处罚时间
        String punishDate = "";
        //TODO 处罚文号
        String punishNo = "";
        ...
        if((punishNo.equals("")||punishNo.equals("null")||punishNo.equals("NULL")||punishNo==null)&&titleStr.contains("处罚决定书")&&titleStr.contains("号")){
            //TODO 处罚文号
            punishNo=titleStr.substring(titleStr.indexOf("处罚决定书") ,titleStr.indexOf("号")+1);
        }
