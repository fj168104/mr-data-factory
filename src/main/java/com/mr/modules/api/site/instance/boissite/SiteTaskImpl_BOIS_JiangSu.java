...
@Component("jiangsu")
@Scope("prototype")
public class SiteTaskImpl_BOIS_JiangSu extends SiteTaskExtend{
    /**
     * 江苏保监局处罚 提取所需要的信息
...
protected String execute() throws Throwable {
    String url = "http://www.circ.gov.cn/web/site24/tab3392/info4094142.htm";
    String fullTxt = getData(url);
    extractContent(fullTxt);
    log.info("----------------------江苏保监局处罚信息提取完成------------------------");
    return null;
}
}	