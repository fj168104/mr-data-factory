...
import com.mr.modules.api.site.instance.boissite.util.ParseLiaoNing;
...
@Slf4j
@Component("bois_liaoning")
@Scope("prototype")
public class SiteTaskImpl_BOIS_LiaoNing extends SiteTaskExtendSub {
    /**
     * 获取：全量、增量
...
//        String url = "http://anhui.circ.gov.cn/web/site11/tab3388/module8940/page1.htm";
    ...
    public List extractPageUrlList(){
        ...
        //第一个页面，用于获取总页数
        // http://liaoning.circ.gov.cn/web/site43/tab3418/module8948/page1.htm
        String baseUrl = "http://liaoning.circ.gov.cn/web/site43/tab3418/module8948/page1.htm";
        //解析第一个页面，获取这个页面上下文
        String fullTxt = getData(baseUrl);
        //获取页数
        int  pageAll= extractPage(fullTxt);
        for(int i=1;i<=pageAll;i++){
            String url ="http://liaoning.circ.gov.cn/web/site43/tab3418/module8948/page"+i+".htm";
            ...
            for(Element element : elementsHerf){
                ...
                String resultUrl = "http://liaoning.circ.gov.cn"+elementUrl.attr("href");
    ...
    public Map extractContent(String fullTxt) {
        //发布机构
        String publishOrg = "中国保监会辽宁保监局行政处";
        //发布时间
        String publishDate = "";
        //TODO 处罚机关（由于有些页面没有，所以暂且给予默认值）
        String punishOrg = "辽宁保监局";
        //TODO 处罚时间
        String punishDate = "";
        //TODO 处罚文号
        String punishNo = "";
        ...
        Map resMap = new ParseLiaoNing().parseInfo(fullTxt);
