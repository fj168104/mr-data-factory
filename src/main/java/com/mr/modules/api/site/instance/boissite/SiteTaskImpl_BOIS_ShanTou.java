...
import com.mr.modules.api.site.instance.boissite.util.ParseShanTou;
...
@Slf4j
@Component("bois_shantou")
@Scope("prototype")
public class SiteTaskImpl_BOIS_ShanTou extends SiteTaskExtendSub {
    /**
     * 获取：全量、增量
...
//        String url = "http://anhui.circ.gov.cn/web/site11/tab3388/module8940/page1.htm";
    ...
    public List extractPageUrlList(){
        ...
        //第一个页面，用于获取总页数
        String baseUrl = "http://guangdong.circ.gov.cn/web/site53/tab4679/module13910/page1.htm";
        //解析第一个页面，获取这个页面上下文
    ...
    public Map extractContent(String fullTxt) {
        //发布机构
        String publishOrg = "中国保监会广东监管局汕头保监分局行政处";
        //发布时间
        String publishDate = "";
        //TODO 处罚机关（由于有些页面没有，所以暂且给予默认值）
        String punishOrg = "汕头保监分局";
        //TODO 处罚时间
        String punishDate = "";
        //TODO 处罚文号
        String punishNo = "";
        ...
        Map resMap = new ParseShanTou().parseInfo(fullTxt);
