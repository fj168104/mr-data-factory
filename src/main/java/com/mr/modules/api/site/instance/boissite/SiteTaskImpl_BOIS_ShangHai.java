...
@Component("shanghai")
@Scope("prototype")
public class SiteTaskImpl_BOIS_ShangHai{
    /*@Override
    ...
    public Map extractContent(String fullTxt) {
        ...
        Element elementsSpanChildStr = elementsSpanChild.get(1);//获取SPAN标签中存储了当事人信息的情况数据
...
//        log.info("stringDetail:"+stringDetail);
        ...
        //TODO 正文中没有文号
        if(elementsSpan.get(0).text().indexOf("沪保监罚")>-1){
        ...
        if(stringDetail.indexOf("当事人：")>-1||elementsSpanChildStr.text().indexOf("当事人：")>-1){
            ...
            for(Element elementP : elementsP){
                ...
                if(elementP.text().indexOf("沪保监罚〔")>-1){
