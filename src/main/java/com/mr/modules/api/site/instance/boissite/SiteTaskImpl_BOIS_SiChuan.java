...
//        String url = "http://anhui.circ.gov.cn/web/site11/tab3388/module8940/page1.htm";
    ...
    public List extractPageUrlList(){
        ...
        //第一个页面，用于获取总页数
        String baseUrl = "http://sichuan.circ.gov.cn/web/site34/tab3596/module9888/page1.htm";
        //解析第一个页面，获取这个页面上下文
        String fullTxt = getData(baseUrl);
        //获取页数
        int  pageAll= extractPage(fullTxt);
        for(int i=1;i<=pageAll;i++){
            String url ="http://sichuan.circ.gov.cn/web/site34/tab3596/module9888/page"+i+".htm";
            ...
            for(Element element : elementsHerf){
                ...
                String resultUrl = "http://sichuan.circ.gov.cn"+elementUrl.attr("href");
    ...
    public Map extractContent(String fullTxt) {
        //发布机构
        String publishOrg = "中国保监会四川保监局行政处";
        //发布时间
        String publishDate = "";
