...
import com.mr.modules.api.site.instance.boissite.util.ParseSuZhou;
...
@Component("suzhou")
@Scope("prototype")
public class SiteTaskImpl_BOIS_SuZhou extends SiteTaskExtendSub {
    @Override
    protected String execute() throws Throwable {
//        String url = "http://jiangsu.circ.gov.cn/web/site61/tab4852/module13407/page2.htm";
    ...
    public List extractPageUrlList(){
        ...
        //第一个页面，用于获取总页数
        String baseUrl = "http://jiangsu.circ.gov.cn/web/site61/tab4852/module13407/page1.htm";
        //解析第一个页面，获取这个页面上下文
        String fullTxt = getData(baseUrl);
        //获取页数
        int  pageAll= extractPage(fullTxt);
        for(int i=1;i<=pageAll;i++){
            String url ="http://jiangsu.circ.gov.cn/web/site61/tab4852/module13407/page"+i+".htm";
    ...
    public Map extractContent(String fullTxt) {
        //发布机构
        String publishOrg = "中国保监会江苏监管局苏州监管分局行政处";
        //发布时间
        String publishDate = "";
        //TODO 处罚机关（由于有些页面没有，所以暂且给予默认值）
        String punishOrg ="苏州保监分局";
        //TODO 处罚时间
        String punishDate = "";
        //TODO 处罚文号
        String  punishNo = "";
        ...
        Map resMap = new ParseSuZhou().parseInfo(fullTxt);
