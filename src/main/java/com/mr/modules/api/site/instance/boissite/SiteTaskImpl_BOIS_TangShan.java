...
@Component("tangshan")
@Scope("prototype")
public class SiteTaskImpl_BOIS_TangShan extends SiteTaskExtendSub {
    @Override
    protected String execute() throws Throwable {
//        String url = "http://hebei.circ.gov.cn/web/site58/tab4774/module13245/page2.htm";
    ...
    public List extractPageUrlList(){
        ...
        //第一个页面，用于获取总页数
        String baseUrl = "http://hebei.circ.gov.cn/web/site58/tab4774/module13245/page1.htm";
        //解析第一个页面，获取这个页面上下文
        String fullTxt = getData(baseUrl);
        //获取页数
        int  pageAll= extractPage(fullTxt);
        for(int i=1;i<=pageAll;i++){
            String url ="http://hebei.circ.gov.cn/web/site58/tab4774/module13245/page"+i+".htm";
            ...
            for(Element element : elementsHerf){
                ...
                String resultUrl = "http://hebei.circ.gov.cn"+elementUrl.attr("href");
