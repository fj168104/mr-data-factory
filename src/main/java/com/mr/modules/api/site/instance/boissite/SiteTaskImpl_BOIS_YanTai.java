...
import com.mr.modules.api.site.instance.boissite.util.ParseYanTai;
...
@Component("yantai")
@Scope("prototype")
public class SiteTaskImpl_BOIS_YanTai extends SiteTaskExtendSub {
    @Override
    protected String execute() throws Throwable {
//        String url = "http://shandong.circ.gov.cn/web/site59/tab4813/module13326/page2.htm";
    ...
    public List extractPageUrlList(){
        ...
        //第一个页面，用于获取总页数
        String baseUrl = "http://shandong.circ.gov.cn/web/site59/tab4813/module13326/page1.htm";
        //解析第一个页面，获取这个页面上下文
        String fullTxt = getData(baseUrl);
        //获取页数
        int  pageAll= extractPage(fullTxt);
        for(int i=1;i<=pageAll;i++){
            String url ="http://shandong.circ.gov.cn/web/site59/tab4813/module13326/page"+i+".htm";
    ...
    public Map extractContent(String fullTxt) {
        //发布机构
        String publishOrg = "中国保监会山东保监局烟台保监分局行政处";
        //发布时间
        String publishDate = "";
        //TODO 处罚机关（由于有些页面没有，所以暂且给予默认值）
        String punishOrg ="烟台保监分局";
        //TODO 处罚时间
        String punishDate = "";
        //TODO 处罚文号
        String  punishNo = "";
        ...
        Map resMap = new ParseYanTai().parseInfo(fullTxt);
