...
@Slf4j
@Component("bois_zhejiang")
@Scope("prototype")
public class SiteTaskImpl_BOIS_ZheJiang extends SiteTaskExtendSub {
...
//        String url = "http://anhui.circ.gov.cn/web/site11/tab3388/module8940/page1.htm";
    ...
    public Map extractContent(String fullTxt) {
        //发布机构
        String publishOrg = "中国保监会浙江保监局行政处";
        //发布时间
        String publishDate = "";
        //TODO 处罚机关（由于有些页面没有，所以暂且给予默认值）
        String punishOrg ="浙江保监局";
        //TODO 处罚时间
        String punishDate = "";
        //TODO 处罚文号
        String  punishNo = "";
        ...
        Map resMap = new ParseZheJiang().parseInfo(fullTxt);
    ...
    public FinanceMonitorPunish getObj(Map<String,String> mapInfo, String href){
        ...
        financeMonitorPunish.setPunishDate(mapInfo.get("punishDate"));//处罚时间financeMonitorPunish.setPartyInstitution(delFinallyString(mapInfo.get("punishToOrg"),"，").replace("（"," ").replace("）"," "));//当事人（公司）=处罚对象
