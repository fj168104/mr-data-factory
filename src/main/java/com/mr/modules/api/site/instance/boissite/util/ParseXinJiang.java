        ...
        if(stringDetail.indexOf("当事人")>-1){
            ...
            for(int i=0;i<listStr.size();i++ ){
                ...
                if(i==0){
                    ...
                    log.info("##################"+firstStr);
                    if((firstStr.contains("当事人") && (firstStr.contains("保险法》") || firstStr.contains("监管规定》") ))){
                ...
                if(textInfo.contains("当事人：") && textInfo.contains("负责人：")){//此为法人
                    ...
                    if(currentPersonStr[0].contains("&&") && currentPersonStr[0].split("&&").length>1){
                        currentPersonStr[0] = currentPersonStr[0].split("&&")[1];
                    }
