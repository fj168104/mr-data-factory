 ...
 */
@Slf4j
@Component("creditchinahenansite0002")
@Scope("prototype")
public class CreditChinaHeNanSite0002 extends SiteTaskExtend_CreditChina{
    @Autowired
    ...
    public void webContext(String keyWord,String ip, String port)throws Throwable{
        String baseUrl = "http://www.xyhn.gov.cn/CMSInterface/cms/getMdList?id=706aa170c91811e783601c3947289257&pagesize=20&start=1&type=2&content=";
        try {
            ...
            if(map.size()>0){
                ...
                if(totalPage>1){
                    for(int i=2;i<=totalPage;i++){
                        urlMain = "http://www.xyhn.gov.cn/CMSInterface/cms/getMdList?id=706aa170c91811e783601c3947289257&pagesize=20&start="+i+"&type=2&content="+ URLEncoder.encode(keyWord,"UTF-8");
    ...
    public DiscreditBlacklist discreditBlacklistInsert(Map<String,String> map){
        ...
        //subject	主题
        discreditBlacklist.setSubject("电子商务失信黑名单");
        //url	url
