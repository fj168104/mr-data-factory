...
/**
 * 重大税收违法案件当事人名单	文本	主体名称 主体代码
 */
@Slf4j
@Component("creditchinahenansite0003")
@Scope("prototype")
public class CreditChinaHeNanSite0003 extends SiteTaskExtend_CreditChina {
    @Autowired
    ...
    public void webContext(String keyWord,String ip, String port)throws Throwable{
        String baseUrl = "http://www.xyhn.gov.cn/CMSInterface/cms/getMdList?id=5ba71bb1ce7f11e78ce51c3947289257&pagesize=20&start=1&type=2&content=";
        try {
            ...
            if(map.size()>0){
                ...
                if(totalPage>1){
                    for(int i=2;i<=totalPage;i++){
                        urlMain = "http://www.xyhn.gov.cn/CMSInterface/cms/getMdList?id=5ba71bb1ce7f11e78ce51c3947289257&pagesize=20&start="+i+"&type=2&content="+ URLEncoder.encode(keyWord,"UTF-8");
    ...
    public DiscreditBlacklist discreditBlacklistInsert(Map<String,String> map){
        ...
        //subject	主题
        discreditBlacklist.setSubject("重大税收违法案件当事人名单");
        //url	url
