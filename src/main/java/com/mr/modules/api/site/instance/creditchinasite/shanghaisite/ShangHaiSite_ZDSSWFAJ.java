 ...
 *提取主题：重大税收违法案件查询
 *提取属性：企业名称、统一社会信用代码、案件性质
 **/
@Slf4j
@Component("ShangHaiSite_ZDSSWFAJ")
@Scope("prototype")
public class ShangHaiSite_ZDSSWFAJ   extends SiteTaskExtend_CreditChina {
    String keyWord =null;
    int pageSize = 1;
    @Autowired
    ...
    public void webContext(String keyWord,String ip, String port){
        ...
        String urlResult = "http://www.shcredit.gov.cn/credit/f/credit/query/?model=zdsswfaj";
