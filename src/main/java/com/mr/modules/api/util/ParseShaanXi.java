...
/**
 * @Author: zqzhou
 * @Description:解析陕西工具类，陕西保监局处罚信息获取处理
 * @Date: Created in 2018/4/3 16:04
 * @Modifyer：zjxu
 */
@Slf4j
public class ParseShaanXi {
    ...
    public  Map parseInfo(String fullText){
        ...
        log.info("Test--stringDetailSource---"+stringDetailSource+"---stringDetail:"+stringDetail);
